...
<div class="main-container">
	<div class="content-container">
		...
		<div class="row">
	    <div class="col-sm-12">
	    	<h3 class="text-center">Search results for : <strong><?php echo $name; ?></strong></h3>
	    </div>
		</div>
		<div class="row">
        	<div class="col-md-12">
        		...
        		<?php while($the_query->have_posts()) : $the_query->the_post(); ?>
                    ...
                    <div class="search-post-box">
                         ...
                         <div class="search-post-content">
                            ...
                            <?php if(!empty(get_the_excerpt())): ?><p><?php echo substr(get_the_excerpt(), 0,90); ?> ...</p><?php endif; ?>
...
<?php else : ?>
	<div class="main-container no-result-container">
<div class="content-container">
<div class="container">
	<div class="row">
    <div class="col-sm-12">
